...
conn = pg2.connect(host='localhost', user='postgres', password='ashokroot', database='demoppp')
...
if SELECT == "Home":
    col1, col2, = st.columns(2)
    col1.image(Image.open("C:/Users/Downloads/phonepe photo/phonepe.png"), width=500)
    with col1:
        st.subheader(
    ...
    with col2:
        st.video("C:/Users/Downloads/phonepe photo/upi.mp4")
...
if SELECT == "About":
    col1, col2 = st.columns(2)
    with col1:
        st.video("C:/Users/Downloads/phonepe photo/pulse-video.mp4")
    with col2:
        st.image(Image.open("C:/Users/Downloads/phonepe photo/PhonePe_Logo.jpg"), width=500)
        st.write("---")
    ...
    with col1:
        ...
        st.image(Image.open("C:/Users/Downloads/phonepe photo/top.jpeg"), width=400)
        with open("C:/Users/Downloads/phonepe photo/annual report.pdf", "rb") as f:
            data = f.read()
        st.download_button("DOWNLOAD REPORT", data, file_name="annual report.pdf")
    with col2:
        st.image(Image.open("C:/Users/Downloads/phonepe photo/report.jpeg"), width=800)
